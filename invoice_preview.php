                ...
                <div class="confirm-send__pop-up">
                        ...
                        <div class="confirm-send__pop-up-buttons">
                                ...
                                <form action="./php_scripts/mail/send_mail.php" method="post">
                                        <input hidden type="text" id="confirm-send-send-btn-hidden-input" name="invoice_no_to_send">
                                        <input hidden type="text" id="pop-up-email-hidden-input" name="recipient_mail">
