...
if (isset($_POST['invoice-no'])) {
        ...
        $db_query = $db->prepare("SELECT * FROM users WHERE id = :id");
        $db_query->bindvalue(':id', $_SESSION['id'], PDO::PARAM_STR);
        $db_query->execute();
        $user = $db_query->fetch(PDO::FETCH_ASSOC);
}
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="invoice__container">
                        <div class="invoice__paper">
                                ...
                                <div class="invoice__paper-content invoice-info">
                                        <p><Strong>Invoice date: </Strong><span id="date-view">
                                                <?php echo $invoice['date'] ?>
                                        </span></p>
                                        <p><Strong>City: </Strong><span id="city-view">
                                                <?php echo $invoice['city'] ?>
                                        </span></p>
                                        <p><Strong>Bank: </Strong><span id="bank-view">
                                                <?php echo $invoice['bank'] ?>
                                        </span></p>
                                        <p><Strong>Account no.: </Strong><span id="account-no-view">
                                                <?php echo $invoice['account_no'] ?>
                                        </span></p>
                                        <p><Strong>Payment term: </Strong><span id="term-view">
                                                <?php echo $invoice['payment_term'] ?>
                                        </span></p>
                                </div>
                                <div class="invoice__paper-content invoice-seller">
                                        <h3>Seller:</h3>
                                        <p><span id="seller-name-view">
                                                <?php echo $user['company_name'] ?>
                                        </span></p>
                                        <p><span id="seller-address1-view">
                                                <?php echo $user['address1'] ?>
                                        </span></p>
                                        <p><span id="seller-address2-view">
                                                <?php echo $user['address2'] ?>
                                        </span></p>
                                        <p><span id="seller-company-no-view">
                                                <?php echo "NIP: ".$user['company_number'] ?>
                                        </span></p>
                                </div>
                                <div class="invoice__paper-content invoice-customer">
                                        <h3>Bill to:</h3>
                                        <p><span id="customer-name-view">
                                                <?php echo $invoice['customer_name'] ?>
                                        </span></p>
                                        <p><span id="customer-address1-view">
                                                <?php echo $invoice['customer_address1'] ?>
                                        </span></p>
                                        <p><span id="customer-address2-view">
                                                <?php echo $invoice['customer_address2'] ?>
                                        </span></p>
                                        <p><span id="customer-company-no-view">
                                        ...
                                        <table>
                                                ...
                                                <tfoot>
                                                        <tr>
                                                                ...
                                                                <td>TOTAL:</td>
                                                                <td></td>
                                                                <td class="preview-total-net">
                                                                        <?php echo $invoice['sum_net']." PLN" ?>
                                                                </td>
                                                                <td class="preview-total-gross">
                                ...
                                <div class="invoice__paper-content invoice-sum">
                                        <p><Strong>To pay: </Strong><span id="invoice__sum-numeric">
                                                <?php echo $invoice['to_pay'] ?>
                                        </span></p>
                                        <p><Strong>In words: </Strong><span id="invoice__sum-verbal">
                                                <?php echo $invoice['to_pay_in_words'] ?>
                                        </span></p>
                                </div>
                                <div class="invoice__paper-content invoice-comments">
                                        <h3>Additional notes</h3>
                                        <p class="comment"><span id="comment-view">
