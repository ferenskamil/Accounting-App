...
<body>
                ...
                <div class="container">
                        <div class="home__top">
                                ...
                                <div class="home__top-right">
                                        ...
                                        <!-- class for menu burger I to menu będzie odpowiednio widoczne na mniejszych rozdzielczościach, na większych nie, i po jego kliknięciu będzie się wyświetlała na moblilnych pozostała cześć menu (ta "right") -->
                                        <div class="home__top-right-btns">
                                                <a href="./loginform.html"><button
        ...
        <a href="./registration.html">Registrition</a>
        <a href="./loginform.html">Login</a>
        <a href="./invoicebrief.html">Invoice brief</a> -->
</body>
